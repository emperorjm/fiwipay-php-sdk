...
/**
 * Class Payment
 * @property \FiwiPay\Api\Payer payer
 * @property \FiwiPay\Api\Transaction transaction
 * @property \FiwiPay\Api\RedirectUrls redirectUrls
 * @property array credentials
 * @property string approvedUrl
 *
 */
class Payment extends FiwiPayModel
{

    /**
     * @param \FiwiPay\Api\Payer $payer
     *
     * @return $this
     */
    ...
    /**
     * @param \FiwiPay\Api\Transaction $transaction
     *
     * @return $this
     */
    ...
    /**
     * @param \FiwiPay\Api\RedirectUrls $redirectUrls
     *
     * @return $this
     */
    ...
    private function getAccessToken() {
        ...
        if (!$array['client_id'] || !$array['client_secret']) {
            //TODO:: Need to handle the response of validation
